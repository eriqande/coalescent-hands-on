...
you a SFS pushed more to the right (more high-frequency variants).  Hint:
...
an SFS that is has more rare variants than expected under the neutral coalescent


4. Super bonus problem: create an excess of high-frequency variants that you would
find in a population that is admixed between two populations back in the past.  
