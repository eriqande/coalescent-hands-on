---
title: "Hands On Exercises and Notebooks to Accompany Lectures on the Coalescent"
...
- [002-the-coalescent-and-demographic-scenarios.nb.html](./002-the-coalescent-and-demographic-scenarios.nb.html) --- Using `ms` to simulate some trees and see how their shapes
...
- [004-one-dimensional-SFS.nb.html](./004-one-dimensional-SFS.nb.html) --- A chance
to generate one-dimensional site frequency spectra from the coalescent under different
demographic scenarios and witness the results.
